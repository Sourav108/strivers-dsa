...
> **Topic Problem Count**: 55 Problems  
> **Language**: C++ (with Intuition, Multi-Tier Approaches, and Complexity Analysis)

## 📌 Overview
1D DP, 2D Grid DP, Subsequences / Knapsack, DP on Strings, DP on Stocks, Longest Increasing Subsequence (LIS), and Partition / MCM DP.
