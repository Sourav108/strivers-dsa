# Pattern-1: Rectangular Star Matrix (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ and Java following the standard 9-section format.

- **Source**: [Pattern-1: Rectangular Star Matrix](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print an $N \times N$ grid of asterisks (`*`).
...
Nested loops: outer loop runs $N$ rows, inner loop prints $N$ stars.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Outer $i \in [0, n-1]$, Inner $j \in [0, n-1]$. Output: Square block of stars. |
