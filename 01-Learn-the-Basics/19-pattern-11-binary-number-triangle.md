# Pattern-11: Binary Number Triangle (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ following the standard 9-section format.

- **Source**: [Pattern-11: Binary Number Triangle](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print alternating 1s and 0s in a right-angled triangle.
...
Parity check: value is `(i + j) % 2 == 0 ? 1 : 0` or alternate starting bit `start = 1 - start`.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Row 0: 1, Row 1: 0 1, Row 2: 1 0 1, Row 3: 0 1 0 1. |
