# Pattern-6: Inverted Number Triangle (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ following the standard 9-section format.

- **Source**: [Pattern-6: Inverted Number Triangle](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print an inverted triangle of numbers $1$ to $N - i$.
...
Inner loop prints $j \in [1, N - i + 1]$.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Row 0: `1 2 3 4 5`, Row 1: `1 2 3 4`. |
