# Pattern-22: Concentric Number Spiral (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ following the standard 9-section format.

- **Source**: [Pattern-22: Concentric Number Spiral](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print concentric square rings of numbers from $N$ down to $1$ in $(2N-1) \times (2N-1)$ matrix.
...
Distance formula: `val = n - min({i, j, 2*n - 2 - i, 2*n - 2 - j})`.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Concentric square layers: 4 4 4 4 4 4 4  |
