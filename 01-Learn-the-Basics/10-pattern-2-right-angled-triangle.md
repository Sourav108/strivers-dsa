# Pattern-2: Right-Angled Triangle (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ following the standard 9-section format.

- **Source**: [Pattern-2: Right-Angled Triangle](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print a right-angled triangle of height $N$ where row $i$ has $i+1$ stars.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Row 0: `*`, Row 1: `* *`, Row 2: `* * *`. |
