...
- **Difficulty**: Easy
- **Statement**: Print consecutive increasing numbers starting from 1 in a triangle.
...
Maintain running counter `num++` across all rows.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | 1  |
