# Pattern-4: Repeating Number Triangle (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ and Java following the standard 9-section format.

- **Source**: [Pattern-4: Repeating Number Triangle](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print row $i$ with number $i$ repeated $i$ times.
...
Outer loop controls number $i$, inner loop repeats it $i$ times.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Row 1: `1`, Row 2: `2 2`, Row 3: `3 3 3`. |
