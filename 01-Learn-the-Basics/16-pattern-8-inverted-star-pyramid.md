# Pattern-8: Inverted Star Pyramid (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ following the standard 9-section format.

- **Source**: [Pattern-8: Inverted Star Pyramid](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print an inverted centered pyramid where row $i$ has $i$ spaces and $2(N - i) - 1$ stars.
...
Symmetry rule: Spaces = $i$, Stars = $2(N - i) - 1$.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Row 0: 0 spaces + 9 stars, Row 1: 1 space + 7 stars, ... |
