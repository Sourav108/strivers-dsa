# Pattern-15: Inverted Letter Triangle (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ following the standard 9-section format.

- **Source**: [Pattern-15: Inverted Letter Triangle](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print inverted triangle of letters A to A+(N-i-1).
...
Inner loop prints `'A'` to `'A' + n - i - 1`.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | A B C D E  |
