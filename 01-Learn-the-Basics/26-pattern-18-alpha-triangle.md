# Pattern-18: Alpha Triangle (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ and Java following the standard 9-section format.

- **Source**: [Pattern-18: Alpha Triangle](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print right-angled triangle starting from reverse letters `'E'`, `'E D'`, `'E D C'`.
...
Row $i$ starts at `'A' + n - 1` down to `'A' + n - 1 - i`.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | E  |
