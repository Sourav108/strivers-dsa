# Pattern-9: Diamond Star Pattern (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ and Java following the standard 9-section format.

- **Source**: [Pattern-9: Diamond Star Pattern](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Combine Pattern 7 (Pyramid) and Pattern 8 (Inverted Pyramid) to form a diamond.
...
Execute Pattern 7 for top half, Pattern 8 for bottom half.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Full diamond of $2N$ rows. |
