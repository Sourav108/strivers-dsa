...
- **Difficulty**: Easy
- **Statement**: Print solid butterfly wings of $2N - 1$ rows with central space shrinking then expanding.
...
Stars $i$, spaces $2(N-i)$, stars $i$ for top half, inverted for bottom.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Full butterfly wings. |
