...
- **Difficulty**: Easy
- **Statement**: Print hollow diamond of stars with expanding central space then contracting.
...
Top half: stars = $N-i$, spaces = $2i$, stars = $N-i$. Bottom half: inverted.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Hourglass  |
