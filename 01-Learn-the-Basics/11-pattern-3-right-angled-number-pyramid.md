# Pattern-3: Right-Angled Number Pyramid (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ and Java following the standard 9-section format.

- **Source**: [Pattern-3: Right-Angled Number Pyramid](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print a right-angled triangle where row $i$ prints numbers $1$ to $i+1$.
...
Inner loop prints value $j+1$ for $j \in [0, i]$.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Row 1: `1`, Row 2: `1 2`, Row 3: `1 2 3`. |
