...
- **Difficulty**: Easy
- **Statement**: Print a centered pyramid where row $i$ has $N - 1 - i$ spaces followed by $2i + 1$ stars.
...
Symmetry rule: Spaces = $N - 1 - i$, Stars = $2i + 1$.
...
|---|---|---|
| `Row 0` | Computes spaces and characters | Row 0: 4 spaces + 1 star, Row 1: 3 spaces + 3 stars, ... |
