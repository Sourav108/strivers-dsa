# Pattern-17: Alpha Hill Pyramid (Step 1.2 — Build-up Logical Thinking (Patterns))

This is a complete, interview-ready note in C++ and Java following the standard 9-section format.

- **Source**: [Pattern-17: Alpha Hill Pyramid](https://takeuforward.org/strivers-a2z-dsa-course/must-do-pattern-problems-must-do-questions)
- **Difficulty**: Easy
- **Statement**: Print centered palindrome alphabet pyramid: `   A   `, `  ABA  `, ` ABCBA `.
...
Spaces = $N-1-i$, letters increase to midpoint then decrease.
